    ...
    <div className="footer">
      ...
      <div className='footer__center'>
        ...
        <SkipPreviousIcon className='footer__icon'/>
          {playing ?<PauseCircleOutlineIcon onClick={track ? stopPlaying : null} fontSize='large'className='footer__icon'/> :
                    <PlayCircleOutlineIcon onClick={track ? startPlaying : null} fontSize='large'className='footer__icon'/>}
